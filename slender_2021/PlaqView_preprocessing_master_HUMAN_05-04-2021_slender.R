...
plaqviewobj <- readRDS(file = "plaqviewobj_presingleR.rds")
...
# we dont need to this here because i renamed htis earlier in line 106
...
### actual transfer 
# need to set default assay in this one just in case
...
Idents(object = plaqviewobj) <- "predicted.id_tabulus.sapien"
difflist <- Seurat::FindAllMarkers(plaqviewobj)
write_csv(difflist, file = "differential/diff_by_predicted.id_tabulus.sapien.csv")
