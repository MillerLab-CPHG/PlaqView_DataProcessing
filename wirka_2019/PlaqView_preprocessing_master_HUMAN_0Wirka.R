...
saveRDS(plaqviewobj, file = "Wirka_with_TS_05032021.rds")
saveRDS(plaqviewobj.cds, file = "Wirka_with_TS_05032021_RDS.rds")

plaqviewobj <- readRDS(file = "Wirka_with_TS_05032021.rds")
